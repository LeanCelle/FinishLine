...
let productos = [
  ...
  const productosFiltrados = productos.filter((producto, indice) => indice >= 32);
  ...
  function filtrarPorMarca(marca) {
    ...
    const filtroMarca = productos.filter((p) => p.marca === marca && p.seccion === "niños");
